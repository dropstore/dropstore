        ...
        <View style={{ flex: 1 }}>
          {
            PAY_WAYS.map((item, index) => (
              ...
              >
                ...
                <Image style={styles.paySel} source={choosedIndex === index ? Images.sel : Images.unSel} />
              </TouchableOpacity>
            ))
          }
        </View>
        <BottomPay notNeedManagement price={data.price} onPress={debounce(this.pay)} text="支付" />
      </View>
    );
  }
}
